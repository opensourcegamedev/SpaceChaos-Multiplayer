...
Für den Netzwerk-Teil des Spiels setzen wir auf einen (Fork)[(https://github.com/crykn/kryonet)] des bekannten [KryoNet](https://github.com/EsotericSoftware/kryonet)-Frameworks.
